...
COMMENT ON COLUMN inquiry.inquiryno is '문의 번호';
COMMENT ON COLUMN inquiry.memberno is '회원 번호';
COMMENT ON COLUMN inquiry.inquiryTitle is '문의 제목';
COMMENT ON COLUMN inquiry.inquiryReason is '문의 사유';
