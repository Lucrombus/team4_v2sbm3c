...
CREATE TABLE member(
		...
		gender                              VARCHAR(10) DEFAULT 'N' NOT NULL,
		birth                               DATE NOT NULL,
...
INSERT INTO member(memberno, id, password, name, tel, rdate, rankno, experience, gender, birth, education) 
VALUES(member_seq.nextval, 'kd1', 1234, '가길동', '010-0000-0000', sysdate, 1, 'Y', '남성', '19990905', '고졸');
INSERT INTO member(memberno, id, password, name, tel, rdate, rankno, experience, gender, birth, education) 
...
ORDER BY memberno ASC;
  ...
  MEMBERNO ID                             PASSWORD             NAME                 TEL            RDATE                    RANKNO EXPERIENCE GENDER     BIRTH                EDUCATION 
---------- ------------------------------ -------------------- -------------------- -------------- -------------------- ---------- ---------- ---------- -------------------- ----------
