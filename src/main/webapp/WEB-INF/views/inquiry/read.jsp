...
<DIV class='content_body'>
  <ASIDE class="aside_right">
    ...
    <c:if test="${sessionScope.id != null}">
      ...
      <A href="./update_text.do?inquiryno=${inquiryno}&now_page=${param.now_page}&word=${param.word }">문의 수정</A>
      <span class='menu_divide' >│</span>
    ...
    <ul>
      <li class="li_none">
        <DIV style="width: 100%; word-break: break-all;">
          ...
          <span style="font-size: 1.5em; font-weight: bold;">${inquiryTitle }</span><br>
