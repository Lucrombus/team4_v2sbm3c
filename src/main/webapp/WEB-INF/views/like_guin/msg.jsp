  ...
  <fieldset class='fieldset_basic'>
    <UL>
      <c:choose>
        ...
        <c:when test="${code == 'property_different'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_success">다른 회원의 정보는 조회할 수 없습니다</span>
          </LI> 
        </c:when> 
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='/mypage/mypage_main.do?memberno=${sessionScope.memberno}'" class="btn btn-info btn-sm">마이페이지</button>
      </LI>
    </UL>
  </fieldset>
