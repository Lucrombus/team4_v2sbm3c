...
<A href="./list_all_search_paging.do?now_page=1" class='title_link'>이벤트</A> 
> 새 이벤트 등록</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm' method='POST' action='./create.do' enctype="multipart/form-data">
    ...
    <div class="content_body_bottom">
      ...
      <button type="button" onclick="location.href='./list_all_search_paging.do?now_page=1'" class="btn btn-primary">목록</button>
    </div>
