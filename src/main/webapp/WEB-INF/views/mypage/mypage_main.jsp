	  ...
	  <DIV class='myinfo_box'>
	    <c:if test="${sessionScope.rankno == 1}">
		  ...
		  <c:if test="${sessionScope.rankno == 2 || sessionScope.rankno == 3}">
		    <a href="/answer/list_by_memberno.do?memberno=${memberno}"><IMG src="/mypage/images/inquiry.png" style='width: 40%; margin-bottom: 10px;'></a><br>
	      <button type='button' onclick="location.href='/answer/list_by_memberno.do?memberno=${memberno}'" class="btn btn-secondary">문의</button>
	    </c:if>
	  </DIV>
	  <DIV class='myinfo_box' >
	    <a href="/resume/list_by_memberno_search_paging.do?memberno=${memberno}&now_page=1"><IMG src="/mypage/images/resume.png" style='width: 40%; margin-bottom: 10px;'></a><br>
	    <button type='button' onclick="location.href='/resume/list_by_memberno_search_paging.do?memberno=${memberno}&now_page=1'" class="btn btn-secondary">내 이력서</button>
	  </DIV>
	</DIV>
