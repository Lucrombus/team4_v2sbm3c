...
<script type="text/javascript">
  $(function() { // 자동 실행[$();], 동적 이벤트 설정 :  여러 상황에 따라 버튼이 실행하는 함수 변경 가능한 패턴
	  // id가 'btn_send'인 태그가 클릭되면 'send' 함수 실행 설정 
    $('#btn_send').on('click', send);

    // id가 'btn_close인 태그가 클릭되면 setFocus 함수를 실행, Dialog창을 닫은후의 focus 이동
